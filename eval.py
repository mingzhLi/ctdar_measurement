...
class eval:
    ...
    def gene_ret_lst(self):
        ret_lst = []
        for iou in [0.6]:   #[0.6,0.7,0.8,0.9]
    ...
    def evaluate_result_str(gt_dom, result_dom, iou_value, table_iou_value=0.8):
        ...
        for gt_table, ress_table in table_matches:
            ...
            # print("gt:",gt_table._cells)
            # print("res:",ress_table._cells)
            # print(cell_mapping)
            # print()
            ...
            for ar in gt_AR:
                try:
                    resFromCell = cell_mapping[ar[0]]
                    resToCell   = cell_mapping[ar[1]]
                    direction = ar[2]
                    predict = (resFromCell, resToCell, direction)
                    # print(predict)
                    if (predict in res_AR):
                        correct_dect += 1
